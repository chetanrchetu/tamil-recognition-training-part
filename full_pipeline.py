...
def perform_segemenation(image_path):
    ...
    for cnt in contours_with_positions:
        ...
        cv2.rectangle(orig,(x-5,y-5),(x+w+5,y+h+5),(0,255,0),2)

        # Save your contours or characters
        cv2.imwrite(r"D:\major_project\project-1\segmented_images" + f'\{i}' + ".png", roi)

        i = i + 1
    
    cv2.imwrite(r'box.png',orig)
...
def predict_(path):
    ...
    string_to_send=prediction_part(r'D:\major_project\project-1\segmented_images')
    translated=translate_tamil(string_to_send)

    return translated,string_to_send


if __name__=='__main__':
    y_pred,y=predict_(r'D:\major_project\megha\project-1\mother.png')
